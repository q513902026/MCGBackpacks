...
public class CloneCommand extends HopeCommand {
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] strings) {
        ...
        if (plugin.itemIsBackpack(player.getInventory().getItemInMainHand())) {
            ...
            commandSender.sendMessage(ColorTool.color(plugin.getPrefix() + FormatTool.getFormatText("clone.error2", "&cYou must be holding a backpack for this to work!")));
        }
        return true;
    }
}
